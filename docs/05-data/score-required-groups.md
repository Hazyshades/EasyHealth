...
The review-results and clearer-report actions are recovery entry points only. The shared reported-results recovery UX is verified by the EH-147 QA checklist and issue #127; reviewed panel specimen policy is implemented by #111 (`cbc_whole_blood`); scoped context confirmation and catalog promotion are not shipped.
