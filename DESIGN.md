...
- **Rule:** pair text + hue with a decorative variant icon; never rely on color alone. Success uses Check, warning/error AlertCircle, and info Info. The icon is aria-hidden because the label supplies the accessible name.### FilterChip
