...
| EH-151 Scoped Shares | share migration; `src/lib/share-links/**`; owner creation endpoint; public `/share/**` page/API and its export-actions integration slot; public response policy; `QA/eh-151/**` | EH-152 consumes the management repository seam. EH-153 supplies the export-actions component and contract; EH-151 remains the public share-page writer and wires that component. EH-154 inspects the public boundary but does not create a second verifier. |
