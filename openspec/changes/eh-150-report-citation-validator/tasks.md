...
- [ ] 3.2 Verify sanitization does not preserve unsupported factual prose or unsafe directives, removed claims never serialize, and valid limited reports show limitations while EH-148 read-time archive/delete status remains `SOURCE_UNAVAILABLE`.
