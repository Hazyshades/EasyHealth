...
## Purpose
Keep Registry 2.0 candidate releases fail-closed until every required approval is bound to the verified candidate-input hash, and keep renewal evidence auditable.
