# Censored laboratory results

## Purpose

Define the laboratory value contract for preserving printed comparator and detection-limit results as text across extraction, correction, Biomarkers, comparison, and Health Profile admission.
