# Resolver Decision Trace

## Purpose
Preserve privacy-safe resolver decision rationale with its normalization revision so reviews remain reproducible across catalog and resolver changes.
