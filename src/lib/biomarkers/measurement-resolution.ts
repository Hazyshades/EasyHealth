...
export const MEASUREMENT_CATALOG_MANIFEST_VERSION = "2026-08-23.0";
/**
 * 12: EH-141 makes MCV a reviewed core Blood readiness and contribution input.
...
const MCH_POLICY: MeasurementUnitPolicy = {
...
const REVIEWED_DEFINITIONS: readonly MeasurementDefinition[] = [
  ...
  reviewed({ key: "mcv_whole_blood", analyteKey: "mcv", displayName: "Mean corpuscular volume", specimen: "whole_blood", property: "mean_cell_volume", scale: "quantitative", timing: "point_in_time", method: "automated", valueKind: "numeric", aliases: cbcAliases(["mcv"], { fixtureValues: ["Mean corpuscular volume (MCV)"] }), unitPolicy: VOLUME_POLICY, binding: assessment("blood", "mcv", "core", { coversConfidence: true, readinessGroup: "mcv", contributionGroup: "mcv" }) }),
  ...([["mch", "Mean corpuscular hemoglobin", "mass_per_cell", MCH_POLICY, ["Mean corpuscular hemoglobin (MCH)"]], ["mchc", "Mean corpuscular hemoglobin concentration", "substance_concentration", PROTEIN_POLICY, ["Mean corpuscular hemoglobin concentration (MCHC)"]], ["mpv", "Mean platelet volume", "mean_cell_volume", VOLUME_POLICY, ["Mean platelet volume (MPV)"]], ["pdw", "Platelet distribution width", "distribution_width_cv", PERCENT_POLICY, ["Platelet distribution width (PDW)"]], ["plateletcrit", "Plateletcrit", "percentage", PERCENT_POLICY, ["Plateletcrit (PCT)"]]] as const).map(([key, displayName, property, unitPolicy, fixtureValues]) => reviewed({ key: key === "plateletcrit" ? "plateletcrit_percent" : key === "pdw" ? "pdw_cv" : `${key}_whole_blood`, analyteKey: key, displayName, specimen: "whole_blood", property, scale: "quantitative", timing: "point_in_time", method: "automated", valueKind: "numeric", aliases: cbcAliases([key], { fixtureValues }), unitPolicy })),
