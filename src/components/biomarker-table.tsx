                ...
                >
                  <DataTableCell className="font-medium">
                    ...
                    (o.modifier && o.modifier !== "none") ? (
                      <span className="mt-0.5 block text-caption font-normal text-[var(--eh-text-muted)]">
                  ...
                  <DataTableCell>
                    ...
                    {o.converted && o.original_unit != null && (
                      <span
                        className="mt-0.5 block text-caption text-[var(--eh-text-muted)]"
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-[var(--eh-text-primary)]">
                      {displayValue(o)}
                      {o.converted && o.original_unit != null && (
                        <span className="mt-0.5 block text-caption text-[var(--eh-text-muted)]">
                          Lab: {o.original_value} {o.original_unit}
                        </span>
                      )}
                    </p>
