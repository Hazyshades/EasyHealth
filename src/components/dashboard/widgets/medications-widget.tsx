...
export function MedicationsWidget(_props: DashboardWidgetProps) {
  ...
  return (
    <SurfaceCard padding="lg" className="flex h-full flex-col" {...hoverProps}>
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-sm font-medium text-[var(--eh-text-secondary)]">Medications</p>
        ...
        <DashboardCardIcon icon={AmbulanceIcon} iconRef={iconRef} />
      </div>
      <p className="mt-3 text-sm text-[var(--eh-text-secondary)]">Add medications</p>
