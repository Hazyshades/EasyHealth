...
- [x] `pnpm test:eh126-db` passed on the disposable clean Supabase database (26 pgTAP assertions): event creation, backfill-compatible ownership, date roles and validation, sync RPC, nullable projections, observation linkage, profile scoping, and deterministic database ordering.
