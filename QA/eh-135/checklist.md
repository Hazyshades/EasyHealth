...
- [x] Non-trend/qualitative synthetic CBC result deep-link smoke retained both `measurement` and `observation` query context in Biomarkers and kept the selected row visible. Verified 2026-09-03.
