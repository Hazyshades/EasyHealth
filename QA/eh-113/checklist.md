...
- [x] `pnpm check:registry-v2-candidate-corpus` — passed on 2026-08-03. `launchable=true` for candidate input `ecd6b53479e846482a6f317a0d20544827e1a846e5eb4994d52acee58fa68c9f`; all 44 rows and technical thresholds passed, with zero approval, fixture, processing, false-concrete, or unclassified-row errors. The four project-owner approvals are hash-bound to this exact candidate.
